...
// Criando nossos servidores falsos numa função chamada criarServidorComAtraso para remover alguns códigos desnecessários do nosso teste e reduzir repetições.
// Ao chamar uma função com o prefixo defer, ela será chamada após o término da função que a contém.
// Utilizamos o defer quando queremos que a função seja executada no final de uma função, mas mantendo essa instrução próxima de onde o servidor foi criado.